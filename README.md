...
## Supported Platforms
- [Cloudflare Workers](https://workers.cloudflare.com/), in main branch. <https://edgebin.liujiacai.net>
- [Deno Deploy](https://deno.com/deploy), in deno branch (work in progress). <https://edgebin.jiacai2050.deno.net/>
